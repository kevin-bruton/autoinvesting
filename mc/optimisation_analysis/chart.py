...
if len(sys.argv) > 1:
  filename = f'./entries/{sys.argv[1]}.csv'
else:
...
def show_chart(percentage_positive_profits, mean_net_profit, bin_size=1000):
...
print(f"The mean Net Profit is: ${mean_net_profit:.2f}")

# %%
#show_chart(percentage_positive_profits, mean_net_profit)
# %%
